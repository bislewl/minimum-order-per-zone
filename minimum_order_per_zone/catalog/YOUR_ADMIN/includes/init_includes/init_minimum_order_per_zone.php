<?php
 ...
 $module_constant = 'MINIMUM_ORDER_PER_ZONE_VERSION';
 $module_installer_directory =  DIR_FS_ADMIN.'includes/installers/minimum_order_per_zone';
 $module_name = "Minimum Order Per Zone"; 

 
 //Just change the stuff above... Nothing down here should need to change
 if(defined('MINIMUM_ORDER_PER_ZONE_VERSION')) 
     { 
        $current_version =  MINIMUM_ORDER_PER_ZONE_VERSION; 
     } 
     else { 
