...
Description
===========
This will allow you to set a minimum order by order total or item total based on the zones you defined in
Admin -> Locations / Taxes -> Zones Definitions

Then taking those values set up your values in Admin -> Configuration  MINIMUM ORDER PER ZONE
